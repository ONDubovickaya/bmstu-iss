...
model_text_bow_softmax.add(Input(shape=(MAX_WORDS_COUNT,)))
model_text_bow_softmax.add(Dense(200, activation='relu'))

model_text_bow_softmax.add(Dropout(0.25))
model_text_bow_softmax.add(BatchNormalization())

model_text_bow_softmax.add(Dense(writers_count, activation='softmax'))

compile_train_eval_model('model_01_BagOfWords', model_text_bow_softmax,
                         x_train_01, y_train,
                         x_test_01, y_test,
